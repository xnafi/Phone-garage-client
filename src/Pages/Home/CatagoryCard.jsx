...
const CatagoryCard = ({ brand }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
            ...
            <div className="w-56 btn glass my-5 -mt-10 overflow-hidden rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
                <Link to={`/brand/${_id}`} className="flex items-center text-center justify-center px-3 py-2 dark:bg-gray-700 ">
