...
const CheckOutPage = ({ paymentDetails }) => {
  ...
  const { productModel, bookingUserEmail, productPrice, _id, productId } =
    paymentDetails;
  ...
  return (
    <form onSubmit={handleSubmit} className="my-10">
      ...
      />
      <button
        className="btn btn-warning my-10"
        type="submit"
      ...
      <div className="my-3">
        {success && (
          <>
            ...
            <br />
            <span className="text-red-600 font-bold animate-pulse">
              Your Transition Id : {transationId}
            </span>
            <br />
            <Link to="/mybooking" className="btn btn-primary my-2">
              Back to my booking
            </Link>
          </>
        )}
