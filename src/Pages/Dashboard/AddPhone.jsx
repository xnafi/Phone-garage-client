    ...
    <>
      <div className="flex z-30 flex-col">
        {currentUser?.verify === false ? (
          <h2 className="text-2xl font-bold text-warning my-4">
            Please wait admin need to verify
          </h2>
        ) : (
          <div className="w-full max-w-md md:p-8 p-2 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 bg-neutral">
            <form
              ...
              noValidate=""
              action=""
              className="space-y-6 ng-untouched ng-pristine ng-valid text-gray-400"
            >
              <div className="dropdown w-full space-y-1 text-sm text-gray-400">
                ...
                >
                  {brands.map((sp) => (
                    <option key={sp._id}>{sp.brand}</option>
                  ))}
                </select>
              </div>
              <div className="space-y-1 text-sm">
                <label for="Model" className="block dark:text-gray-400">
                  Phone Model
                </label>
                <input
                  type="text"
              ...
              <div className="dropdown w-full space-y-1 text-sm text-gray-400">
                ...
                >
                  {option.map((sp) => (
                    <option key={sp._id}>{sp.condition}</option>
                  ))}
                </select>
              </div>
              <div className="space-y-1 text-sm">
