...
const SignUp = () => {
  ...
  const { createUserWithEmail, user, updateUser, signInWithGoogle } =
    ...
    <div className="md:my-20 my-10  px-4 lg:px-10 items-center justify-center flex">
      <div className="w-full max-w-md md:p-8 p-2 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 bg-neutral">
        ...
        >
          ...
          <div className="space-y-1 text-sm">
            <label for="image" className="block dark:text-gray-400">
              Image
            </label>
            <input
              type="file"
              {...register("image", { required: true })}
              className="file-input file-input-bordered w-full px-4 bg-white rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400 "
            />
          </div>
          ...
          <button
            type="submit"
            className="block w-full p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400 btn glass"
          >
            Sign up
          </button>
        </form>
        ...
        <p className="text-center sm:px-6 dark:text-gray-400 text-sm">
          Have an account?
          <Link
            to="/login"
            rel="noopener noreferrer"
            href="#"
            className="underline dark:text-gray-100 pl-1"
          >
            Login
          </Link>
        </p>
